      ...
      <div ref={ref} className="relative max-w-4xl mx-auto px-6 text-center">
        ...
        <div className={`scroll-hidden scroll-hidden-delay-2 ${isVisible ? 'scroll-visible' : ''} flex flex-col sm:flex-row items-center justify-center gap-4`}>
          ...
          <a
            ...
            className="bg-[#25d366] hover:bg-[#20bd5a] text-white px-8 py-4 rounded-full text-lg font-medium transition-all duration-300 hover:shadow-lg hover:shadow-[#25d366]/25 inline-flex items-center gap-3"
          >
