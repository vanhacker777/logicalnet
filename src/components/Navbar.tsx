        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <a
              ...
              className="bg-brand hover:bg-brand-dark text-white px-5 py-2 rounded-full text-sm font-medium transition-all duration-300"
            >
              Contactar
            </a>
          </div>
          ...
          <div className="flex lg:hidden items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-brand hover:bg-brand-dark text-white w-9 h-9 rounded-full flex items-center justify-center"
            >
