      ...
      <div ref={heroRef} className="relative max-w-6xl mx-auto px-6 py-24 w-full">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className={`scroll-hidden scroll-hidden-delay-4 ${isVisible ? 'scroll-visible' : ''} flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-8`}>
              ...
              <div className="flex items-center gap-3 text-sm text-white/60">
                ...
                <a href="https://wa.me/34601475239" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors flex items-center gap-1.5">
