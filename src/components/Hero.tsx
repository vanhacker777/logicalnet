          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all hover:shadow-xl hover:shadow-green-500/25 hover:-translate-y-0.5 text-center flex items-center justify-center gap-3"
              >
              ...
              <a
                ...
                className="bg-brand hover:bg-brand-dark text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all hover:shadow-xl hover:shadow-brand/25 hover:-translate-y-0.5 text-center flex items-center justify-center gap-3"
              >
