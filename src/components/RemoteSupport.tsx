  ...
  return (
    <section id="soporte" className="py-24 bg-[#0f172a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-r from-secondary to-accent border border-white/10 rounded-3xl p-8 md:p-12">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-4 flex items-center gap-4">
                ...
                <div>
                  <p className="text-white font-semibold">Horario de atencion</p>
                  <p className="text-gray-400 text-sm">Lunes a viernes de 9:00 a 14:00 y de 16:00 a 19:00</p>
                </div>
              </div>
            </div>

            <div className="space-y-4">
              <h3 className="text-xl font-bold text-white mb-6">Ventajas</h3>
              ...
              <a
                href="#contacto"
                className="inline-block mt-6 bg-brand hover:bg-brand-dark text-white px-6 py-3 rounded-lg font-semibold transition-all hover:shadow-lg"
              >
                Saber mas
              </a>
            </div>
