        ...
        <div className="grid md:grid-cols-4 gap-6">
          {steps.map((step, index) => (
            <div key={index} className="relative">
              <div className="bg-gradient-to-b from-brand/10 to-transparent border border-brand/20 rounded-2xl p-8 h-full hover:border-brand/50 transition-all duration-300">
                <span className="text-5xl font-black text-brand/20 block mb-4">{step.number}</span>
