...
const services = [
  ...
  },
  {
    ...
    description: 'Posicionamos tu web y gestionamos campanas que generan resultados.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Apps y paneles de gestion que se integran con tu forma de trabajar.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Diseno web',
    description: 'Paginas y tiendas online que convierten visitas en ventas.',
  },
];
